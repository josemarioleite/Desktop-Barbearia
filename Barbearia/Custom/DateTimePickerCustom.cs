...
namespace CustomControls.RJControls
{
    public class DateTimePickerCustom : DateTimePicker
    {
        ...
        private Image calendarIcon = Barbersoft.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Barbersoft.Properties.Resources.calendarDark;
                else calendarIcon = Barbersoft.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
